...
public class CncProgramValidatorTest {
    ...
    CncProgram cncProgramActual = new CncProgram(cncProgramId, cncProgramNumber, cncProgramOperationNumber,cncProgramText,cncProgramCreationDate,
            cncProgramComment, isActive, detailActual, cncMachineActual, loginPersonnelNumber);
    ...
    public void isOperationNumberValid() {
        boolean actualOperatinNumber = cncProgramValidator.isOperationNumberValid(Integer.toString(cncProgramOperationNumber));
    ...
    public void isCncMachineCodeEquipmentValid() {
        boolean actualCncMachineCodeEquipment = cncProgramValidator.isCncMachineCodeEquipmentValid(Integer.toString(codeEquipment));

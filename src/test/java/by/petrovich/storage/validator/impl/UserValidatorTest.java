...
public class UserValidatorTest {
    ...
    public void testIsUserValidWhenUserValidReturnTrue() {
        ...
        User userActual = new User(65484, "efwef23!#", "Иван", "Иванов",
                "Рудольфович", EmployeePosition.CNC_PROGRAMMER, "ivanov@mail.ru");
        User userActual1 = new User(12345, "кпоулр!уаkh534", "John", "Smith",
                "Smitovich", EmployeePosition.ENGINEERING_TECHNICIAN,"america@usa.com");
        User userActual2 = new User(54218, "кпоу(efw:ef3234", "Слесарев", "Николай",
                "Иванович", EmployeePosition.CNC_PROGRAMMER,"bigBoss@gov.no");
        User userActualWithRole = new User(84576, "кпоswgv)wef234", "Ролевой", "Роман",
                "Иванович", EmployeePosition.CNC_PROGRAMMER, "withRole@sm.com");
